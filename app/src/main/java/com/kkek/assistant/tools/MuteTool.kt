...
class MuteTool @Inject constructor(private val repository: AssistantRepository) : AiTool {
    override val name = "toggleMute"
    override val description = "Toggles the microphone mute state during a call."
    ...
    override suspend fun execute(
        ...
        return ToolResult.Success(mapOf("status" to "Mute toggled"))
    }
}
